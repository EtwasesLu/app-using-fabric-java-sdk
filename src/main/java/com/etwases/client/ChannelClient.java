...
public class ChannelClient {
	...
	String name;
	Channel channel;
	com.etwases.client.FabricClient fabClient;
	...
	public com.etwases.client.FabricClient getFabClient() {
		return fabClient;
	}
	 ...
	 * @param fabClient
	 */
	public ChannelClient(String name, Channel channel, com.etwases.client.FabricClient fabClient) {
		this.name = name;
